...
enemy_images = {
  ...
  "medium": pg.image.load('Part 1/assets/images/enemies/enemy_2.png').convert_alpha(),
  "strong": pg.image.load('Part 1/assets/images/enemies/enemy_3.png').convert_alpha(),
  "elite": pg.image.load('Part 1/assets/images/enemies/enemy_4.png').convert_alpha()
}
#buttons
...
upgrade_turret_image = pg.image.load('Part 1/assets/images/buttons/upgrade_turret.png').convert_alpha()
begin_image = pg.image.load('Part 1/assets/images/buttons/begin.png').convert_alpha()
restart_image = pg.image.load('Part 1/assets/images/buttons/restart.png').convert_alpha()
fast_forward_image = pg.image.load('Part 1/assets/images/buttons/fast_forward.png').convert_alpha()
#gui
heart_image = pg.image.load("Part 1/assets/images/gui/heart.png").convert_alpha()
coin_image = pg.image.load("Part 1/assets/images/gui/coin.png").convert_alpha()
logo_image = pg.image.load("Part 1/assets/images/gui/logo.png").convert_alpha()

#load sounds
shot_fx = pg.mixer.Sound('Part 1/assets/audio/shot.wav')
